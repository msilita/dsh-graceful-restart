					...
					(() => {
						...
						return jsx("div", { style: { marginTop: 8, padding: 8, borderRadius: 6, background: "rgba(198,40,40,0.08)", border: "1px solid rgba(198,40,40,0.3)" } },
							errs.map(function (h, ei) {
								return jsx("div", { key: "err" + ei, style: { fontSize: 12, color: "#c62828", whiteSpace: "pre-wrap", wordBreak: "break-all", marginBottom: ei < errs.length - 1 ? 8 : 0 } },
									"⚠ " + fmtAt(h.error.at) + " " + (h.error.detail || ""));
							}),
						);
					})(),
				]),
