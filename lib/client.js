		...
		function SettingsSection() {
			...
			return jsx("div", { style: { padding: 4 } }, [
				...
				jsx("div", { style: rowStyle }, [
					...
					// 错误信息（独立记录，不在快照条目里）：完整显示（两级：概要在上，具体报错缩进在下；不弹窗）
					(() => {
						...
						return jsx("div", { style: { marginTop: 8, padding: 8, borderRadius: 6, background: "rgba(198,40,40,0.08)", border: "1px solid rgba(198,40,40,0.3)" } },
							errs.map(function (e, ei) {
								return jsx("div", { key: "err" + ei, style: { fontSize: 12, color: "#c62828", marginBottom: ei < errs.length - 1 ? 8 : 0 } }, [
									jsx("div", { style: { whiteSpace: "pre-wrap", wordBreak: "break-all" } }, "⚠ " + fmtAt(e.at) + " " + (e.detail || "")),
									e.stderr ? jsx("pre", { style: { margin: "4px 0 0", padding: "6px 8px", borderRadius: 4, background: "rgba(0,0,0,0.35)", color: "#e0b3b3", fontSize: 11, whiteSpace: "pre-wrap", wordBreak: "break-all" } }, e.stderr) : null,
								]);
							}),
						);
					})(),
